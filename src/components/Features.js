        ...
        <ScrollView style={{ height: hp(60) }} bounces={false} showsVerticalScrollIndicator={false} className="space-y-4">
            ...
            <View className="bg-blue-400 p-4 rounded-xl space-y-2">
                <View className="flex-row items-center space-x-1">
                    ...
                    <Text style={{ fontSize: wp(4.8) }} className="font-semibold text-white-700">ChatGPT</Text>
                </View>

                <Text style={{ fontSize: wp(3.8) }} className="text-white-700 font-medium">
            ...
            <View className="bg-blue-300 p-4 rounded-xl space-y-2">
                <View className="flex-row items-center space-x-1">
                    <Image className="rounded-ful" source={require('../../assets/images/dalleIcon.png')} style={{ height: hp(4), width: hp(4) }} />
                    <Text style={{ fontSize: wp(4.8) }} className="font-semibold text-white-700">DALL-E</Text>
                </View>
            ...
            <View className="bg-blue-400 p-4 rounded-xl space-y-2">
                <View className="flex-row items-center space-x-1">
                    ...
                    <Text style={{ fontSize: wp(4.8) }} className="font-semibold text-white-700">Smart AI</Text>
                </View>
